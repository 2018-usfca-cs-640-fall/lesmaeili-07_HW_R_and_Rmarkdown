...
```{r histogramsdust}
# Here we're using the dplyr piping syntax to select a subset of rows matching 
# specify (using the filter) function, and then pull out a column
...
```{r histogramssebum}
# Here we're using the dplyr piping syntax to select a subset of rows matching 
#  we specify (using the filter) function, and then pull out a column
joined_blast_data_metadata %>%
...
# Conclusion
Looking at the Figures 1, 2 (age) and Figures 3, 4 (environmal samples ) has 
